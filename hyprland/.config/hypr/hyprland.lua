-- HYPRLAND CONFIG (Lua).
-- Draft migration from hyprland.conf, generated 2026-08-30.
-- hyprland.conf is kept alongside this file until it's verified working.
...
hl.config({
    input = {
        ...
        kb_variant = "",
        kb_model   = "",
        kb_options = "caps:escape, grp:r_ctrl_toggle",
        kb_rules   = "",
...
-- Example per-device config (leftover from the stock template; harmless unless
-- you actually have a device named "epic-mouse-v1" -- delete if unused)
...
hl.bind("SUPER + Control_R", hl.dsp.exec_cmd("hyprctl switchxkblayout all next"))
